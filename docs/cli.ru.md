...
| `verify-deploy` | проверить, что сборка ПРАВДА применилась к приложению: задачи с ошибками (в них файл и позиция ошибки компиляции), сверка применённой сборки, доступность адреса; ничего не деплоит |
